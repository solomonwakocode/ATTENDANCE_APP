    ...
    <div>
      ...
      <div className="flex justify-center items-center min-h-screen bg-[#EAF5F4] px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row rounded-2xl shadow-2xl overflow-hidden max-w-6xl w-full">
          ...
          <div className="flex flex-col justify-center items-center md:items-start md:w-1/2 px-8 md:px-14 py-10" style={{backgroundImage: ` url(${Pattern})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed'}} >
            {" "}
          ...
          {/* Right - Illustration */}
          <div className="hidden md:flex md:w-1/2 justify-center items-center  relative p-10" style={{backgroundImage: ` url(${Pattern})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed'}}>
