...
try {
  ...
  return (
    <div>
      <Header />  
      <div className="flex justify-center items-center min-h-screen bg-[#EAF5F4] px-6 py-10"> <div className="flex flex-col md:flex-row rounded-2xl shadow-2xl overflow-hidden max-w-6xl w-full">
{/* Left - Form */} <div className="flex flex-col justify-center items-center md:items-start md:w-1/2 px-8 md:px-14 py-10"> <h2 className="font-extrabold text-3xl text-orange-600 mb-8 self-start" >
Sign Up </h2>
